...
Private Declare Function ProgIDFromCLSID Lib "ole32" ( _
    pCLSID As Any, _
    lpszProgID As Long _
) As Long
...
Public Function CreateObjectFromFile( _
    ...
    For i = 0 To UBound(udtCoCls)
        If StrComp(udtCoCls(i).prgid, strProgID, vbTextCompare) = 0 Then
...
Private Function GetCoClasses( _
    ...
    hRes = LoadTypeLib(StrPtr(strFile), oTypeLib)
...
Private Function CLSIDToProgID( _
